import { r as f, R as y, j as k } from "./index-CVHl686y.js";
const x = (...o) =>
  o
    .filter((e, t, a) => !!e && e.trim() !== "" && a.indexOf(e) === t)
    .join(" ")
    .trim();
const S = (o) => o.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase();
const T = (o) =>
  o.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, a) => (a ? a.toUpperCase() : t.toLowerCase()));
const w = (o) => {
  const e = T(o);
  ...
  (
    ...
    f.createElement(
      "svg",
      {
        ...
        className: x("lucide", u),
        ...(!r && !A(h) && { "aria-hidden": "true" }),
        ...h,
      },
      [...m.map(([s, l]) => f.createElement(s, l)), ...(Array.isArray(r) ? r : [r])],
    ),
);
const d = (o, e) => {
  const t = f.forwardRef(({ className: a, ...u }, r) =>
    f.createElement(E, {
      ref: r,
      iconNode: e,
      className: x(`lucide-${S(w(o))}`, `lucide-${o}`, a),
      ...u,
    }),
  );
  return ((t.displayName = w(o)), t);
};
const C = [
    [
      "path",
  ...
  constructor() {
    ((this.subscribe = (e) => (
      ...
      (this.create = (e) => {
        var t;
        const { message: a, ...u } = e,
          r = typeof e?.id == "number" || ((t = e.id) == null ? void 0 : t.length) > 0 ? e.id : v++,
          m = this.toasts.find((i) => i.id === r),
        ...
        return (
          ...
          m
            ? (this.toasts = this.toasts.map((i) =>
                i.id === r
                  ? (this.publish({ ...i, ...e, id: r, title: a }),
                    { ...i, ...e, id: r, dismissible: h, title: a })
                  : i,
              ))
            : this.addToast({ title: a, ...u, dismissible: h, id: r }),
          r
        );
      }),
      (this.dismiss = (e) => (
      ...
      (this.promise = (e, t) => {
        ...
        const u = Promise.resolve(e instanceof Function ? e() : e);
        let r = a !== void 0,
          m;
        const h = u
            .then(async (s) => {
              if (((m = ["resolve", s]), y.isValidElement(s)))
                ((r = !1), this.create({ id: a, type: "default", message: s }));
              else if (W(s) && !s.ok) {
                r = !1;
                const n =
                  ...
                  g =
                    typeof t.description == "function"
                      ...
                      : t.description,
                  p = typeof n == "object" && !y.isValidElement(n) ? n : { message: n };
                this.create({ id: a, type: "error", description: g, ...p });
              } else if (s instanceof Error) {
                r = !1;
                const n = typeof t.error == "function" ? await t.error(s) : t.error,
                  g = typeof t.description == "function" ? await t.description(s) : t.description,
                  p = typeof n == "object" && !y.isValidElement(n) ? n : { message: n };
                this.create({ id: a, type: "error", description: g, ...p });
              } else if (t.success !== void 0) {
                r = !1;
                const n = typeof t.success == "function" ? await t.success(s) : t.success,
                  g = typeof t.description == "function" ? await t.description(s) : t.description,
                  p = typeof n == "object" && !y.isValidElement(n) ? n : { message: n };
                this.create({ id: a, type: "success", description: g, ...p });
              }
            })
            .catch(async (s) => {
              if (((m = ["reject", s]), t.error !== void 0)) {
                r = !1;
                const l = typeof t.error == "function" ? await t.error(s) : t.error,
                  n = typeof t.description == "function" ? await t.description(s) : t.description,
                  b = typeof l == "object" && !y.isValidElement(l) ? l : { message: l };
                this.create({ id: a, type: "error", description: n, ...b });
              }
            })
            .finally(() => {
          ...
          i = () =>
            new Promise((s, l) => h.then(() => (m[0] === "reject" ? l(m[1]) : s(m[1]))).catch(l));
...
const c = new $(),
  q = (o, e) => {
    const t = e?.id || v++;
    return (c.addToast({ title: o, ...e, id: t }), t);
  },
  W = (o) =>
    o &&
    typeof o == "object" &&
...
function dt({ children: o, delay: e = 0, className: t = "", ...a }) {
  ...
  return (
    f.useEffect(() => {
      ...
      const i = new IntersectionObserver(
        (s) => {
          s.forEach((l) => {
            l.isIntersecting && (setTimeout(() => m(!0), e), i.unobserve(l.target));
          });
        },
        { threshold: 0.15 },
      );
      return (i.observe(h), () => i.disconnect());
    }, [e]),
    k.jsx("div", { ref: u, className: `reveal ${r ? "visible" : ""} ${t}`, ...a, children: o })
  );
}
const ct = {
  images: { logoUrl: "", heroUrl: "", instructorUrl: "", featureUrl: "" },
  hero: {
