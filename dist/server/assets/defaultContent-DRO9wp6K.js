...
function Reveal({ children, delay = 0, className = "", ...rest }) {
  ...
  return /* @__PURE__ */ jsx("div", { ref, className: `reveal ${visible ? "visible" : ""} ${className}`, ...rest, children });
}
const DEFAULT_CONTENT = {
  ...
  hero: {
    ...
    description: "A complete one-year guided yoga journey by Pooja Ingle. Daily live sessions, expert mentorship, and a thriving community — designed for real Indian lifestyles.",
    startDate: "TODAY",
  ...
  mentor: {
    ...
    description: "For over a decade, Pooja has guided thousands of women and men into a daily yoga practice that fits real Indian lives. SATTVAYOGA 365 is her vision — to make transformation simple, accessible and joyful for everyone, every single day.",
    statsStudents: "1K+",
    statsPlan: "365",
    statsRating: "4.9★",
    experienceYears: "1+"
  ...
  bestStudents: {
    ...
    subtitle: "Meet the dedicated yogis who transformed their health, discipline, and daily energy.",
    students: [
      {
        name: "Aarav Mehta",
        ...
        quote: "Daily morning yoga with Pooja has completely changed my day. The stiffness is gone and my focus is sharper than ever!",
      ...
      },
      {
        ...
        quote: "365 days seemed tough, but the supportive community makes it easy. I feel so energized and happy every morning!",
      ...
      },
      {
        ...
        quote: "Yoga has become my daily medicine. The breathing techniques helped me manage stressful surgeries with absolute calm.",
  ...
  reels: {
    ...
    subtitle: "Watch clips of our daily sessions, custom yoga posture tutorials, and student milestones directly on our feed.",
    items: [
      {
